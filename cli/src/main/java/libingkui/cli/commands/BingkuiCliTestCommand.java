 ...
 */
package libingkui.cli.commands;
...
public class BingkuiCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BingkuiCliTestCommand.class);
    protected final BingkuiCliCommands service;

    public BingkuiCliTestCommand(final BingkuiCliCommands service) {
